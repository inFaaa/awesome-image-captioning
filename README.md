...
- [Papers](#papers)
  - [Survey](#survey)
  - [Before](#before) - [2015](#2015) - [2016](#2016) - [2017](#2017) - [2018](#2018) - [2019](#2019) - [2020](#2020) - [2021](#2021)
- [Dataset](#dataset)
...
* [Human Consensus-Oriented Image Captioning](https://www.ijcai.org/Proceedings/2020/0092.pdf) - Wang et al, `IJCAI 2020`.
* [Non-Autoregressive Image Captioning with Counterfactuals-Critical Multi-Agent Learning](https://arxiv.org/pdf/2005.04690.pdf) - Guo et al, `IJCAI 2020`.
* [Recurrent Relational Memory Network for Unsupervised Image Captioning](https://www.ijcai.org/Proceedings/2020/0128.pdf) - Guo et al, `IJCAI 2020`.

#### *`EMNLP 2020`*

* [SSCR: Iterative Language-Based Image Editing via Self-Supervised Counterfactual Reasoning](https://www.aclweb.org/anthology/2020.emnlp-main.357.pdf)- Fu et al, `EMNLP 2020`.
* [CapWAP: Image Captioning with a Purpose](https://www.aclweb.org/anthology/2020.emnlp-main.705.pdf) - Adam Fisch et al, `EMNLP 2020`.
* [Generating Image Descriptions via Sequential Cross-Modal Alignment Guided by Human Gaze](https://www.aclweb.org/anthology/2020.emnlp-main.377.pdf) - Ece Takmaz et al, `EMNLP 2020`.
...
* [Say As You Wish: Fine-grained Control of Image Caption Generation with Abstract Scene Graphs(oral)](http://openaccess.thecvf.com/content_CVPR_2020/papers/Chen_Say_As_You_Wish_Fine-Grained_Control_of_Image_Caption_Generation_CVPR_2020_paper.pdf) - Chen S et al, `CVPR 2020`.
...
* [Show, Edit and Tell: A Framework for Editing Image Captions](https://openaccess.thecvf.com/content_CVPR_2020/papers/Sammani_Show_Edit_and_Tell_A_Framework_for_Editing_Image_Captions_CVPR_2020_paper.pdf) - Fawaz Sammani et al, `CVPR 2020`.
* [Context-Aware Group Captioning via Self-Attention and Contrastive Features](https://openaccess.thecvf.com/content_CVPR_2020/papers/Li_Context-Aware_Group_Captioning_via_Self-Attention_and_Contrastive_Features_CVPR_2020_paper.pdf) - Li et al, `CVPR 2020`.
* [Meshed-Memory Transformer for Image Captioning](https://openaccess.thecvf.com/content_CVPR_2020/papers/Cornia_Meshed-Memory_Transformer_for_Image_Captioning_CVPR_2020_paper.pdf) - Marcella Cornia et al, `CVPR 2020`.
* [Transform and Tell: Entity-Aware News Image Captioning](https://openaccess.thecvf.com/content_CVPR_2020/papers/Tran_Transform_and_Tell_Entity-Aware_News_Image_Captioning_CVPR_2020_paper.pdf) - Alasdair Tran et al, `CVPR 2020`.
...
* [Compare and Reweight: Distinctive Image Captioning Using Similar Images Sets](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/1417_ECCV_2020_paper.php) - Wang J et al, `ECCV 2020`.
* [TextCaps: a Dataset for Image Captioning with Reading Comprehension](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/4358_ECCV_2020_paper.php)- Oleksii Sidorov et al, `ECCV 2020`.
* [Length-Controllable Image Captioning](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/2035_ECCV_2020_paper.php) - Deng C et al, `ECCV 2020`.
* [Comprehensive Image Captioning via Scene Graph Decomposition](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/2115_ECCV_2020_paper.php)- Zhong Y et al, `ECCV 2020`. [[code]](https://github.com/doubledaibo/2dcaption_eccv2018)
* [Towards Unique and Informative Captioning of Images](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/350_ECCV_2020_paper.php) - Wang Z et al, `ECCV 2020`.
* [Learning Visual Representations with Caption Annotations](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/498_ECCV_2020_paper.php)- Mert Bulent Sariyildiz et al, `ECCV 2020`.
* [Fashion Captioning: Towards Generating Accurate Descriptions with Semantic Rewards](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/1763_ECCV_2020_paper.php)- Yan X et al, `ECCV 2020`.
* [Captioning Images Taken by People Who Are Blind](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/2783_ECCV_2020_paper.php)- Danna Gurari et al, `ECCV 2020`.
* [Learning to Generate Grounded Visual Captions without Localization Supervision](https://www.ecva.net/papers/eccv_2020/papers_ECCV/html/2981_ECCV_2020_paper.php)- Ma C et al, `ECCV 2020`.

#### *`NeurIPS 2020`*

- [Diverse Image Captioning with Context-Object Split Latent Spaces](https://papers.nips.cc/paper/2020/file/24bea84d52e6a1f8025e313c2ffff50a-Paper.pdf)- Shweta Mahajan et al, poster, `NeurIPS 2020`.
- [RATT: Recurrent Attention to Transient Tasks for Continual Image Captioning](https://papers.nips.cc/paper/2020/file/c2964caac096f26db222cb325aa267cb-Paper.pdf)- Riccardo Del Chiaro et al, poster, `NeurIPS 2020`.

- [Prophet Attention: Predicting Attention with Future Attention](https://proceedings.neurips.cc/paper/2020/file/13fe9d84310e77f13a6d184dbf1232f3-Paper.pdf)- Liu F et al, poster, `NeurIPS 2020`.
